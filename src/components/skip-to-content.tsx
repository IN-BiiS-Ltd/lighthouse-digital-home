...
export function SkipToContent() {
  ...
  return (
    <a
      href="#main"
      className="sr-only focus:not-sr-only focus:fixed focus:z-[100] focus:rounded-md focus:bg-gold focus:px-4 focus:py-2.5 focus:text-sm focus:font-semibold focus:text-navy focus:shadow-[0_12px_40px_-12px_rgba(0,0,0,0.5)] focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2 focus:ring-offset-navy"
      style={{
