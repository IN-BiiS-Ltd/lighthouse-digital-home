...
const motes: Mote[] = [
  ...
  { top: "60%", left: "62%", size: "6.5rem", opacity: 0.33, dur: "40s", delay: "0.6s", dx: "-1rem",   dy: "-1.4rem", rot: "5deg" },
  { top: "78%", left: "32%", size: "6.25rem",opacity: 0.31, dur: "46s", delay: "0.9s", dx: "1rem",    dy: "-2.2rem", rot: "10deg" },
  { top: "84%", left: "86%", size: "5rem", opacity: 0.26, dur: "50s", delay: "2.4s", dx: "-1.2rem", dy: "-1.6rem", rot: "-4deg" },
