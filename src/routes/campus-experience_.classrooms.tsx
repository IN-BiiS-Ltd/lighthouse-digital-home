...
export const Route = createFileRoute("/campus-experience_/classrooms")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/campus-experience/classrooms" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/campus-experience/classrooms" }],
  }),
  component: Page,
});
