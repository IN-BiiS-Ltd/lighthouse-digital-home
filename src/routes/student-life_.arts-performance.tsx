...
export const Route = createFileRoute("/student-life_/arts-performance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/student-life/arts-performance" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/student-life/arts-performance" }],
  }),
  component: Page,
});
