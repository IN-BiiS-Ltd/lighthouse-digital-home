...
export const Route = createFileRoute("/our-model_/graduate-profile")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/our-model/graduate-profile" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/our-model/graduate-profile" }],
  }),
