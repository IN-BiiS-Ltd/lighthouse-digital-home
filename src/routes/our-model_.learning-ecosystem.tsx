...
export const Route = createFileRoute("/our-model_/learning-ecosystem")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/our-model/learning-ecosystem" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/our-model/learning-ecosystem" }],
  }),
