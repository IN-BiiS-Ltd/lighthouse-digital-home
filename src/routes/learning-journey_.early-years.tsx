...
export const Route = createFileRoute("/learning-journey_/early-years")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/learning-journey/early-years" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/learning-journey/early-years" }],
  }),
