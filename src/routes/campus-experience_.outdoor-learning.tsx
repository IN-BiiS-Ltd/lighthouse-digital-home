...
export const Route = createFileRoute("/campus-experience_/outdoor-learning")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/campus-experience/outdoor-learning" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/campus-experience/outdoor-learning" }],
  }),
  component: Page,
});
