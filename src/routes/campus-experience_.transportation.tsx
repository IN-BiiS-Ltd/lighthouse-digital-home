...
export const Route = createFileRoute("/campus-experience_/transportation")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/campus-experience/transportation" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/campus-experience/transportation" }],
  }),
  component: Page,
});
