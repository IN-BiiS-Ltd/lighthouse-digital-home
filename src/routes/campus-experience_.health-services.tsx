...
export const Route = createFileRoute("/campus-experience_/health-services")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/campus-experience/health-services" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/campus-experience/health-services" }],
  }),
  component: Page,
});
