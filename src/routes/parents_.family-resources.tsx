...
export const Route = createFileRoute("/parents_/family-resources")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/parents/family-resources" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/parents/family-resources" }],
  }),
  component: Page,
});
