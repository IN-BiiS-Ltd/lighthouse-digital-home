...
import { Palette, Sun, Compass, Shield } from "lucide-react";
...
const acronym = [
  ...
  { letter: "S", title: "Sustainability", body: "Caring for our environment, resources, and communities so that future generations can thrive with responsibility and hope, while also advancing institutional and educational sustainability.", img: principleStewardship },
...
const palette = [
  { name: "Executive Blue", swatch: "#3A4F9F", ink: "text-white", body: "A symbol of trust, wisdom, confidence, stability, and thoughtful leadership." },
