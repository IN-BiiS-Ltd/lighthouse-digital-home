...
export const Route = createFileRoute("/admissions_/application-process")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/admissions/application-process" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/admissions/application-process" }],
  }),
  component: Page,
});
