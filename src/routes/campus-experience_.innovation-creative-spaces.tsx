...
export const Route = createFileRoute("/campus-experience_/innovation-creative-spaces")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/campus-experience/innovation-creative-spaces" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/campus-experience/innovation-creative-spaces" }],
  }),
  component: Page,
});
