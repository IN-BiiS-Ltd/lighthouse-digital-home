...
export const Route = createFileRoute("/our-model_/assessment-framework")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/our-model/assessment-framework" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/our-model/assessment-framework" }],
  }),
