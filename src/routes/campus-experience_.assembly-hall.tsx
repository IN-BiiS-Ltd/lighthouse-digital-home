...
export const Route = createFileRoute("/campus-experience_/assembly-hall")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/campus-experience/assembly-hall" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/campus-experience/assembly-hall" }],
  }),
  component: Page,
});
