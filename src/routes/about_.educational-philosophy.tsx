...
export const Route = createFileRoute("/about_/educational-philosophy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/about/educational-philosophy" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/about/educational-philosophy" }],
  }),
