...
export const Route = createFileRoute("/learning-journey_/secondary")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/learning-journey/secondary" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/learning-journey/secondary" }],
  }),
  component: Secondary,
});
