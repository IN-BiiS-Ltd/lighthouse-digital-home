...
export const Route = createFileRoute("/our-model_/parent-partnership")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/our-model/parent-partnership" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/our-model/parent-partnership" }],
  }),
