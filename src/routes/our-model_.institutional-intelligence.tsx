...
export const Route = createFileRoute("/our-model_/institutional-intelligence")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/our-model/institutional-intelligence" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/our-model/institutional-intelligence" }],
  }),
