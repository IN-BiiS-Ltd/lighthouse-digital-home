...
export const Route = createFileRoute("/student-life_/wellbeing")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/student-life/wellbeing" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/student-life/wellbeing" }],
  }),
  component: Page,
});
...
const config = {
  ...
  "related": [
    ...
    },
    {
      ...
      "body": "Practical guidance families use to support wellbeing at home."
    },
    {
