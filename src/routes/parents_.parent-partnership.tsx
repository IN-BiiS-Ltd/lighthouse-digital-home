...
export const Route = createFileRoute("/parents_/parent-partnership")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/parents/parent-partnership" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/parents/parent-partnership" }],
  }),
  component: Page,
});
