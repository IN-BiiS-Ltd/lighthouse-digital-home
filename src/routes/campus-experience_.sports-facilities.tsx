...
export const Route = createFileRoute("/campus-experience_/sports-facilities")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/campus-experience/sports-facilities" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/campus-experience/sports-facilities" }],
  }),
  component: Page,
});
