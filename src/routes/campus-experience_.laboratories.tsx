...
export const Route = createFileRoute("/campus-experience_/laboratories")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/campus-experience/laboratories" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/campus-experience/laboratories" }],
  }),
  component: Page,
});
