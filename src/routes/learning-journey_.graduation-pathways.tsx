...
export const Route = createFileRoute("/learning-journey_/graduation-pathways")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/learning-journey/graduation-pathways" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/learning-journey/graduation-pathways" }],
  }),
