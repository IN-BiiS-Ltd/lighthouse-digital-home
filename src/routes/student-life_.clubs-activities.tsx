...
export const Route = createFileRoute("/student-life_/clubs-activities")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/student-life/clubs-activities" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/student-life/clubs-activities" }],
  }),
  component: Page,
});
