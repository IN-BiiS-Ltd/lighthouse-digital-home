...
export const Route = createFileRoute("/student-life_/community-belonging")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/student-life/community-belonging" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/student-life/community-belonging" }],
  }),
  component: Page,
});
