        ...
        config={{
          ...
          modules: [
            ...
            },
            {
              ...
              tiles: [
                { title: "Academic Year Announcements", body: "Open registration dates and new academic year updates.", icon: <Bell className="size-5" />, to: "/admissions/academic-year-announcements" },
