...
export const Route = createFileRoute("/community_/community-programmes")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/community/community-programmes" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/community/community-programmes" }],
  }),
  component: Page,
});
