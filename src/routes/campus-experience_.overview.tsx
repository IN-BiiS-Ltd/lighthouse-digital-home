...
export const Route = createFileRoute("/campus-experience_/overview")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/campus-experience/overview" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/campus-experience/overview" }],
  }),
  component: Page,
});
