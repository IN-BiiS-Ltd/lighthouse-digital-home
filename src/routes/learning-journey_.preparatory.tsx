...
export const Route = createFileRoute("/learning-journey_/preparatory")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/learning-journey/preparatory" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/learning-journey/preparatory" }],
  }),
