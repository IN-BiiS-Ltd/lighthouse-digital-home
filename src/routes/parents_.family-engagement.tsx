...
export const Route = createFileRoute("/parents_/family-engagement")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/parents/family-engagement" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/parents/family-engagement" }],
  }),
  component: Page,
});
