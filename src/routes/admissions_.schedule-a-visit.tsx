...
export const Route = createFileRoute("/admissions_/schedule-a-visit")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/admissions/schedule-a-visit" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/admissions/schedule-a-visit" }],
  }),
  component: Page,
});
