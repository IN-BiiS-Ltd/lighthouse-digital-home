...
import { Download, CheckCircle2, CalendarDays } from "lucide-react";
    ...
    <>
      ...
      <Section id="library" tone="default">
        ...
        <p className="mt-2 max-w-2xl text-sm text-muted-foreground md:text-base">
          {POSTERS.length} approved posters are currently in circulation. Files are supplied at
          print resolution; the WebP version is lighter for messaging and social channels.
        </p>
