...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#150C57" },
      ...
      { property: "og:image:secure_url", content: SOCIAL_CARD_URL },
          ...
          "@graph": [
            {
              ...
              "@id": "https://lighthousecampus.com/#organization",
            ...
            {
              "@type": "WebSite",
              "@id": "https://lighthousecampus.com/#website",
              url: "https://lighthousecampus.com",
              name: "Lighthouse Campus",
              publisher: { "@id": "https://lighthousecampus.com/#organization" },
              inLanguage: "en",
            },
          ],
        }),
