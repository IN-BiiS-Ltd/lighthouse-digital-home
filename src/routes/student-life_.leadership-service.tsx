...
export const Route = createFileRoute("/student-life_/leadership-service")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lighthousecampus.com/student-life/leadership-service" },
      { property: "og:type", content: "article" },
    ],
    links: [{ rel: "canonical", href: "https://lighthousecampus.com/student-life/leadership-service" }],
  }),
  component: Page,
});
